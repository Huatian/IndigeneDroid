...
public class NetworkImageView extends ImageView {
	...
	private VolleyTransform mTransform;
		...
		ImageContainer newContainer = mImageLoader.get(mUrl, new ImageListener() {
			...
			public void onResponse(final ImageContainer response, boolean isImmediate) {
				...
				if (response.getBitmap() != null) {
					Bitmap localBitmap = mTransform != null ? mTransform.transform(response.getBitmap()): response.getBitmap();;
	...
	public void setTransform(VolleyTransform paramVolleyTransform) {
		this.mTransform = paramVolleyTransform;
	}

	public static abstract class VolleyTransform {
